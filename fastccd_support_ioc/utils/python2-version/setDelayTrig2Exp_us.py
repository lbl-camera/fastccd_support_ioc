...
cin_functions.WriteReg(cin_register_map.REG_DELAYTOEXPOSUREMSB_REG, time_h[0:4], 1)
# Write Number of Exposure Time LSB
cin_functions.WriteReg(cin_register_map.REG_DELAYTOEXPOSURELSB_REG, time_h[4:], 1)
