...
if (regval[4:5] == "F"):
    ...
    if (bin_reg7[0:3] == "000"): print
    "  FCLK HS Divider = 4"
    if (bin_reg7[0:3] == "001"): print
    "  FCLK HS Divider = 5"
    if (bin_reg7[0:3] == "010"): print
    "  FCLK HS Divider = 6"
    if (bin_reg7[0:3] == "011"): print
    "  FCLK HS Divider = 7"
    ...
    print
    "  FCLK N1 Divider = " + str(dec_n1)
    print
    "  FCLK RFREQ = " + reg_val8[7:] + reg_val9[6:7] + "." + reg_val9[7:] + reg_val10[6:] + reg_val11[6:] + reg_val12[
                                                                                                            6:]
    if (bin_reg7[0:3] == "000" and dec_n1 == 8): print
    "  FCLK Frequency = 156 MHz"
    elif (bin_reg7[0:3] == "000" and dec_n1 == 10): print
    "  FCLK Frequency = 125 MHz"
    elif (bin_reg7[0:3] == "001" and dec_n1 == 4): print
    "  FCLK Frequency = 250 MHz"
    elif (bin_reg7[0:3] == "011" and dec_n1 == 4): print
    "  FCLK Frequency = 200 MHz"
    else: print
    "  FCLK Frequency UNKNOWN "

elif (str(int(regval[4:5]) & 1110) == "2"):
    print
"  FCLK Frequency = 250 MHz"
elif (str(int(regval[4:5]) & 1110) == "6"): print
"  FCLK Frequency = 200 MHz"
elif (str(int(regval[4:5]) & 1110) == "A"): print
"  FCLK Frequency = 125 MHz"
