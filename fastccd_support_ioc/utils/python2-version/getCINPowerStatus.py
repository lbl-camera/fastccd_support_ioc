...
if (int(stats_vec[-1]) == 1):
    ...
    print
    "V12P_BUS Power  : {0:.4s}".format(str(voltage)) + "V @ {0:.5s}".format(str(current)) + "A"
    ...
    print
    "V3P3_MGMT Power : {0:.4s}".format(str(voltage)) + "V @ {0:.5s}".format(str(current)) + "A"
    ...
    print
    "V2P5_MGMT Power : {0:.4s}".format(str(voltage)) + "V @ {0:.5s}".format(str(current)) + "A"
    ...
    print
    "V1P8_MGMT Power : {0:.4s}".format(str(voltage)) + "V @ {0:.5s}".format(str(current)) + "A"
    ...
    print
    "V1P2_MGMT Power : {0:.4s}".format(str(voltage)) + "V @ {0:.5s}".format(str(current)) + "A"
    ...
    print
    "V1P0_ENET Power : {0:.4s}".format(str(voltage)) + "V @ {0:.5s}".format(str(current)) + "A"
    ...
    print
    "V3P3_S3E Power  : {0:.4s}".format(str(voltage)) + "V @ {0:.5s}".format(str(current)) + "A"
    ...
    print
    "V3P3_GEN Power  : {0:.4s}".format(str(voltage)) + "V @ {0:.5s}".format(str(current)) + "A"
    ...
    print
    "V2P5_GEN Power  : {0:.4s}".format(str(voltage)) + "V @ {0:.5s}".format(str(current)) + "A"
    ...
    print
    "V0P9_V6 Power   : {0:.4s}".format(str(voltage)) + "V @ {0:.5s}".format(str(current)) + "A"
    ...
    print
    "V1P0_V6 Power   : {0:.4s}".format(str(voltage)) + "V @ {0:.5s}".format(str(current)) + "A"
    ...
    print
    "V1P2_V6 Power   : {0:.4s}".format(str(voltage)) + "V @ {0:.5s}".format(str(current)) + "A"
    ...
    print
    "V2P5_V6 Power   : {0:.4s}".format(str(voltage)) + "V @ {0:.5s}".format(str(current)) + "A"
    ...
    print
    "V_FP Power      : {0:.4s}".format(str(voltage)) + "V @ {0:.5s}".format(str(current)) + "A"
else:
    print
    "  12V Power Supply is OFF"
